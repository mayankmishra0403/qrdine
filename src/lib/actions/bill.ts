  ...
  try {
    const order = await prisma.order.findUnique({
      ...
      include: {
        ...
        restaurant: { select: { name: true, address: true, phone: true, email: true, gstin: true, pan: true, currency: true, billFooter: true } },
  ...
  try {
    ...
    const order = await prisma.order.findUnique({
      ...
      include: {
        ...
        table: { select: { tableNumber: true } },
        restaurant: { select: { name: true, address: true, phone: true, email: true, gstin: true, pan: true, currency: true } },
        customer: { select: { name: true, phone: true, gstin: true, gstCategory: true } },
        payments: { select: { method: true, amount: true, reference: true, createdAt: true } },
        invoice: true,
      },
